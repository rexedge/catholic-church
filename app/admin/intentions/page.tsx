...
export default function IntentionsPage() {
  const [intentions, setIntentions] = useState<IntentionsI[]>([
    {
      id: 1,
      name: "John Doe",
  ...
  const updateIntentionStatus = (id: number, newStatus: StatusI) => {
    setIntentions(
      intentions.map((intention) =>
        intention.id === id ? { ...intention, status: newStatus } : intention
      )
    );
  };
      ...
      <Card>
        ...
        <CardContent>
          <IntentionList
            ...
            onUpdateStatus={updateIntentionStatus}
          />
        </CardContent>
      </Card>
    </div>
